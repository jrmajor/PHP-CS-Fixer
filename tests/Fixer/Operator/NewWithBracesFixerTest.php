...
final class NewWithBracesFixerTest extends AbstractFixerTestCase
{
    ...
    public function provideNamedWithoutBracesCases()
    {
        $tests = [
            ['<?php $x = new X(foo(/**/));'],
            ['<?php $xyz = new X(new Y(new Z(/**/ foo())));'],
    ...
    public function provideAnonymousWithDefaultConfigurationCases()
    {
        return [
    ...
    public function provideAnonymousWithoutBracesCases()
    {
        return [
            ['<?php $a = new class($a) {use SomeTrait;};'],
            ['<?php $a = new class(foo(/**/)) implements Foo{};'],
